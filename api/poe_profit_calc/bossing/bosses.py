...
MAVEN_EXCLUSIVE_GEMS = 15
MAVEN_NON_EXCLUSIVE_GEMS = 20
MAVEN_GEM_DROP_RATE = 0.25
# Total drop rate is 0.25, but the non-exclusive maven gems seem to be more
# common than the exclusive ones.
# from https://docs.google.com/spreadsheets/d/1B1vZq_9vEmifMpl_Bs7gT7jvYFCRLLY1zP-ixAQQKuw/
MAVEN_EXCLUSIVE_GEM_DROP_RATE = MAVEN_GEM_DROP_RATE * (5.5 / 24.5) / MAVEN_EXCLUSIVE_GEMS
MAVEN_NON_EXCLUSIVE_GEM_DROP_RATE = MAVEN_GEM_DROP_RATE * (19 / 24.5) / MAVEN_NON_EXCLUSIVE_GEMS
